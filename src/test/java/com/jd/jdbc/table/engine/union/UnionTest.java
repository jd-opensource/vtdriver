...
package com.jd.jdbc.table.engine.union;
...
public class UnionTest extends TestSuite {
    ...
    public void init() throws SQLException, IOException {
        ...
        testCaseList = initCase("src/test/resources/engine/tableengine/union_case.json", TestCase.class, conn.getCatalog());

    }

    @Test
    public void test_union() throws SQLException, NoSuchFieldException, IllegalAccessException {
        int count = 0;
