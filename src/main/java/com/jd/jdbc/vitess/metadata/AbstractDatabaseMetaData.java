...
public abstract class AbstractDatabaseMetaData extends VitessWrapper implements DatabaseMetaData {

    private final CachedDatabaseMetaData cachedDatabaseMetaData;

    public AbstractDatabaseMetaData(CachedDatabaseMetaData cachedDatabaseMetaData) {
