 ...
 */
package com.jd.jdbc.sqlparser.support.logging;
...
public class LogFactory {
    ...
    static {
        String logType = System.getProperty("vitess.logType");
        if (logType != null) {
    ...
    public static synchronized void selectLog4JLogging() {
        try {
            ...
            Class implClass = Resources.classForName("com.jd.jdbc.sqlparser.support.logging.Log4jImpl");
            logConstructor = implClass.getConstructor(new Class[]{String.class});
        } catch (Throwable t) {
            //ignore
        }
    ...
    public static synchronized void selectJavaLogging() {
        try {
            ...
            Class implClass = Resources.classForName("com.jd.jdbc.sqlparser.support.logging.Jdk14LoggingImpl");
            logConstructor = implClass.getConstructor(new Class[]{String.class});
        } catch (Throwable t) {
            //ignore
        }
