...
import com.jd.jdbc.sqlparser.dialect.mysql.visitor.MySqlEvalVisitorImpl;
import com.jd.jdbc.sqlparser.parser.VitessRuntimeException;
import com.jd.jdbc.sqlparser.utils.HexBin;
import com.jd.jdbc.sqlparser.utils.JdbcUtils;
import com.jd.jdbc.sqlparser.utils.Utils;
import com.jd.jdbc.sqlparser.visitor.functions.*;
...
public class SQLEvalVisitorUtils {
        ...
        if (sqlObject instanceof SQLValuableExpr) {
            ...
            if (value == null) {
                if (throwError && !sqlObject.getAttributes().containsKey(EVAL_VALUE)) {
                    throw new VitessRuntimeException("eval error : " + SQLUtils.toSQLString(sqlObject, dbType));
                }
            }
        }
    ...
    public static Integer castToInteger(Object val) {
        ...
        throw new VitessRuntimeException("cast error");
    }
    ...
    public static Date castToDate(Object val) {
        ...
        throw new VitessRuntimeException("can cast to date");
    }
    ...
    public static Date castToDate(String text) {
        ...
        try {
            ...
            throw new VitessRuntimeException("format : " + format + ", value : " + text, e);
        }
    }
