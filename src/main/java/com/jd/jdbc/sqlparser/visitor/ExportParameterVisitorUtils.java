...
import com.jd.jdbc.sqlparser.dialect.mysql.visitor.MySqlExportParameterVisitor;
...
public final class ExportParameterVisitorUtils {
    ...
    public static SQLExpr exportParameter(final List<Object> parameters, final SQLExpr param) {
        ...
        if (param instanceof SQLCharExpr) {
            ...
            value = ((SQLHexExpr) param).getInteger();
            replace = true;
            ...
            for (int i = 0; i < list.getItems().size(); i++) {
                ...
                if (listItem instanceof SQLCharExpr) {
                    ...
                    Object listValue = ((SQLHexExpr) listItem).getInteger();
                    listValues.add(listValue);
                }
            }
    ...
    public static void exportParameter(final List<Object> parameters, SQLBinaryOpExpr x) {
        ...
        {
            SQLExpr leftResult = com.jd.jdbc.sqlparser.visitor.ExportParameterVisitorUtils.exportParameter(parameters, x.getLeft());
