...
import static com.jd.jdbc.sqlparser.parser.CharTypes.*;
import static com.jd.jdbc.sqlparser.parser.LayoutCharacters.EOI;
import static com.jd.jdbc.sqlparser.parser.SQLParserFeature.*;
import static com.jd.jdbc.sqlparser.parser.Token.*;
...
public class Lexer {
    ...
    public static String parameterize(String sql, String dbType) {
        com.jd.jdbc.sqlparser.parser.Lexer lexer = SQLParserUtils.createLexer(sql, dbType);
