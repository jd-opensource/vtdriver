...
public class SQLSelectQueryBlock extends SQLObjectImpl implements SQLSelectQuery, SQLReplaceable {
    ...
    public void setFrom(com.jd.jdbc.sqlparser.ast.statement.SQLSelectQueryBlock queryBlock, String alias) {
        if (queryBlock == null) {
            this.from = null;
            return;
        }
    ...
    public com.jd.jdbc.sqlparser.ast.statement.SQLSelectQueryBlock clone() {
        com.jd.jdbc.sqlparser.ast.statement.SQLSelectQueryBlock x = new com.jd.jdbc.sqlparser.ast.statement.SQLSelectQueryBlock();
        cloneTo(x);
        return x;
    }
    ...
    public void cloneSelectListTo(com.jd.jdbc.sqlparser.ast.statement.SQLSelectQueryBlock x) {
    ...
    public void cloneTo(com.jd.jdbc.sqlparser.ast.statement.SQLSelectQueryBlock x) {
        ...
        for (SQLSelectItem item : this.selectList) {
            ...
            if (allColumn) {
                if (recursive && from instanceof SQLSubqueryTableSource) {
                    ...
                    com.jd.jdbc.sqlparser.ast.statement.SQLSelectQueryBlock queryBlock = subSelect.getQueryBlock();
                    if (queryBlock != null) {
