...
public class SQLForeignKeyImpl extends SQLConstraintImpl implements SQLForeignKeyConstraint {
    ...
    public void cloneTo(com.jd.jdbc.sqlparser.ast.statement.SQLForeignKeyImpl x) {
        super.cloneTo(x);
    ...
    public com.jd.jdbc.sqlparser.ast.statement.SQLForeignKeyImpl clone() {
        com.jd.jdbc.sqlparser.ast.statement.SQLForeignKeyImpl x = new com.jd.jdbc.sqlparser.ast.statement.SQLForeignKeyImpl();
        cloneTo(x);
        return x;
    }
