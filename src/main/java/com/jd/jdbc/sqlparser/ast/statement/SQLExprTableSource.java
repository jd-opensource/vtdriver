...
import com.jd.jdbc.sqlparser.ast.SQLReplaceable;
...
public class SQLExprTableSource extends SQLTableSourceImpl implements SQLReplaceable {
    ...
    public void cloneTo(com.jd.jdbc.sqlparser.ast.statement.SQLExprTableSource x) {
        x.alias = alias;
        ...
        if (super.hints != null) {
            List<SQLHint> hintList = new ArrayList<>();
            for (SQLHint hint : super.hints) {
