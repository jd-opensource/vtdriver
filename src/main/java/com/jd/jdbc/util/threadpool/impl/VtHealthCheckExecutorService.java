...
public class VtHealthCheckExecutorService extends AbstractVtExecutorService {
    private static final String QUERY_TASK_NAME_FORMAT = "HealthCheckTask-";

    private static final Integer DEFAULT_QUEUE_SIZE = 10000;
